...
<!--            <a href="#!">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <address class="mb-4">Trường đại học Mở TP Hồ Chí Minh</address>
            <p class="mb-1">
              <a class="link-secondary text-decoration-none" href="tel:+15057922430">(505) 792-2430</a>
            </p>
            <p class="mb-0">
              <a class="link-secondary text-decoration-none" href="mailto:2151053018hieu@ou.edu.vn">2151053018hieu@ou.edu.vn</a>
            </p>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
        ...
        <div class="col-12 col-lg-3 col-xl-4">
          <div class="widget">
            ...
            <p class="mb-4">Subscribe to our newsletter to get our news</p>
            <form action="#!">
              <div class="row gy-4">
                <div class="col-12">
