                        ...
                        <c:forEach var="route" items="${routes}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="${pageContext.request.contextPath}/admin/routes/edit/${route.routeId}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i> Chỉnh sửa
                                    </a>
                                    <a href="${pageContext.request.contextPath}/admin/routes/delete/${route.routeId}" class="btn btn-sm btn-danger">
