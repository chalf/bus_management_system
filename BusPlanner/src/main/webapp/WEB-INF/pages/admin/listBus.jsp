    ...
    <body>   
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-10">
                    <h1 class="text-center mb-4"><spring:message code="admin.bus.list"/></h1>
                    ...
                    <!-- Toggle Form Button -->
                    <button type="button" class="btn btn-success mb-3" id="toggleFormBtn">Thêm Xe Buýt</button>
                    ...
                    <table class="table table-hover table-bordered mt-4">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th>Số Xe</th>
                                <th>Tuyến Đường</th>
                                <th class="text-center"></th> <!-- New column for action buttons -->
                            </tr>
                        </thead>
                        <tbody>
        ...
        <script>
                                            document.addEventListener('DOMContentLoaded', function () {
                                                ...
                                                toggleFormBtn.addEventListener('click', function () {
                                                    if (addBusForm.style.display === 'none' || addBusForm.style.display === '') {
                                                        addBusForm.style.display = 'block';
                                                        toggleFormBtn.textContent = 'Ẩn Form Thêm Xe Buýt'; // Change button text
                                                    } else {
                                                        addBusForm.style.display = 'none';
                                                        toggleFormBtn.textContent = 'Thêm Xe Buýt'; // Change button text
                                                    }
                                                });
                                            });
